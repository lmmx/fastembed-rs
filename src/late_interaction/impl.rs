...
use super::{
    LateInteractionEmbedding, LateInteractionInitOptions,
    LateInteractionInitOptionsUserDefined, LateInteractionModel, LateInteractionModelInfo,
    LateInteractionTextEmbedding, UserDefinedLateInteractionModel, DEFAULT_BATCH_SIZE,
};
            ...
            for batch_idx in 0..batch_size_actual {
                ...
                if is_query {
                    ...
                    for seq_idx in 0..seq_len {
                        ...
                        let normalized: Vec<f32> = token_embedding.iter().map(|x| x / norm).collect();
                    ...
                    for (j, &token_id) in input_ids_row.iter().enumerate() {
                        ...
                        if self.skip_list.contains(&token_id_u32) || token_id_u32 == self.pad_token_id {
